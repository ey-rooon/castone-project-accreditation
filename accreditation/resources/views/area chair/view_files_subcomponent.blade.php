                    ...
                    <tbody>
                        @forelse($files as $index => $file)
                            <tr>
                                ...
                                @if (Auth::User()->current_role == 'area member' || Auth::User()->current_role == 'chair')
                                    <td>
                                        <form action="/subcomponent_updatefile_status/{{ $file->id }}"
                                            method="POST">
                                            @csrf
                                                ...
                                                @if (Auth::User()->current_role == 'area member' || Auth::User()->current_role == 'chair')
                                                    <div class="col-12 col-md-3 border rounder overflow-y">
                                                        ...
                                                        <div class="row-12 row-col-2 d-flex align-items-center"
                                                            style="height: 20%;">
                                                            <form method="post" action="/send_message_subcomponent"
                                                                class="message-form">
                                                                @csrf
                                                                ...
                                                                <div class="card p-3 d-flex align-items-center justify-content-between"
                                                                    ...
                                                                    <div>
                                                                        ...
                                                                        <div>
                                                                            ...
                                                                            <a
                                                                                href="/revertsubcomponentfile/{{ $file->id }}/{{ $log->id }}"><i
                                                                                    class="far fa-history"></i></a>

                                                                            <a
                                                                                href="/backupdownload/{{ $log->id }}"><i
        ...
        $('.btn-delete').click(function() {
            ...
            swal({
                ...
                .then((willDelete) => {
                    if (willDelete) {
                        $.ajax({
                            url: '/delete_subcomponent_file/' + fileId,
                            type: 'GET',
                            data: {
                                _token: "{{ csrf_token() }}" // Add this line
                            },
