                        ...
                        @forelse($files as $index => $file)
                            <tr>
                                ...
                                <td>
                                    ...
                                    @if(Auth::User()->current_role == 'area member')
                                        <a href="/delete_subindicator_file/{{$file->id}}" @if($file->status == 'checked') onclick="return false;" @endif>
                                ...
                                @if(Auth::User()->current_role == 'area member')
                                    <td>
                                        <form action="/subindicator_updatefile_status/{{$file->id}}" method="POST">
                                            @csrf
                                            ...
                                            @if(Auth::User()->current_role == 'area member')
                                                <div class="col-12 col-md-3 border rounder overflow-y">
                                                    ...
                                                    <div class="row-12 row-col-2 d-flex align-items-center" style="height: 20%;">
                                                        <form method="post" action="/send_message_subindicator"  class="message-form">
                                                            @csrf
