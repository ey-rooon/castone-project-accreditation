                ...
                <div class="col-md-6">
                    <div class="bg shadow p-4 mb-4 bg-body">
                        <form method="POST" action="{{ route('add_user') }}">
                            @csrf
                            <h1 class="fs-1 text-center mb-4">Form</h1>
                            <div class="mb-3">
                                <label for="firstname" class="form-label">Firstname</label>
                                <input id="firstname" class="form-control @error('firstname') is-invalid @enderror" style="border-radius: 8px;" type="text" name="firstname" value="{{ old('firstname') }}" autofocus>
                            ...
                            <div class="mb-3">
                                ...
                                <input id="lastname" class="form-control @error('lastname') is-invalid @enderror" style="border-radius: 8px;" type="text" name="lastname" value="{{ old('lastname') }}">
                            ...
                            <div class="mb-3">
                                ...
                                <input id="email" class="form-control @error('email') is-invalid @enderror" style="border-radius: 8px;" type="email" name="email" value="{{ old('email') }}">
                            ...
                            {{-- <div class="mb-3">
                                ...
                                <input id="password" class="form-control @error('password') is-invalid @enderror" style="border-radius: 8px;" type="password" name="password">
                            ...
                            <div class="mb-3">
                                ...
                                <input id="password_confirmation" class="form-control @error('password_confirmation') is-invalid @enderror" style="border-radius: 8px;" type="password" name="password_confirmation">
